...
console.log(
  functionalFilterByKey(people, searchFor4, searchBy4, searchMethod4)
);

function functionalFilterByKey2(items = [], searchFor = "", searchBy = "", searchMethod = "startsWith") {
  const final = items.filter((item) =>{
    return eval(`item[searchBy].toLowerCase().${searchMethod}(searchFor.toLowerCase())`);
  });
  return final;
}

console.log(functionalFilterByKey2(people, searchFor1, searchBy1));
console.log(functionalFilterByKey2(people, searchFor2, searchBy2));
console.log(functionalFilterByKey2(people, searchFor3, searchBy3));
console.log(
  functionalFilterByKey2(people, searchFor4, searchBy4, searchMethod4)
);
